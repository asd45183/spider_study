...
class Logger(object):
    ...
    def __init__(self):
        ...
        # 实例化对象，传递日志路径
        self.base_url = os.path.abspath(os.path.dirname(os.path.dirname(__file__)))
        ...
        logging.basicConfig(level=logging.DEBUG,
                            ...
                            filename=(self.set_log_url("files/spider.log"))
                            )
        """
        ...
        if not self.logger.handlers:
            ...
            """
    def set_log_url(self, log_path):
        return '/'.join([self.base_url, log_path])
